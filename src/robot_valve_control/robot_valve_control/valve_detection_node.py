...
class ValveDetectionNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('target_depth_roi_ratio', 0.03)
        self.declare_parameter('target_depth_min_roi_px', 6)
        self.declare_parameter('target_depth_min_points', 9)
        ...
        self.command_pub = self.create_publisher(ValveCommand, command_topic, 1)
    ...
    def decide_command(self, frame, valve_target, small_target):
        ...
        if valve_target is not None:
            ...
            if z_depth_mm > 260:
                ...
                if abs(x_mm) > 5.0 or abs(z_mm) > 5.0:
                    return self.build_command(
                        x=x_mm,
                        y=0.0,
                        z=z_mm,
        ...
        if small_target is not None:
            ...
            if z_depth_mm < 260:
                ...
                if abs(x_mm) < 2.0 and abs(z_mm) < 2.0:
